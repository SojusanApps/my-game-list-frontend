...
import { Friendship, FriendshipRequest, GameList, UserDetail } from "@/client";
import {
...
function FriendshipButtons({ currentUser, userId }: FriendshipButtonsProps) {
...
function UserProfileInformation({ userDetails }: UserProfileInformationProps) {
  return (
    <div>
...
function UserFriendsList({ userDetails }: UserFriendsListProps) {
  return (
    <div>
...
function UserStatistics({ userDetails }: UserStatisticsProps) {
  return (
    <div>
...
function GameListUpdate({ latestGameListUpdate }: GameListUpdateProps) {
  return (
    <div className="flex flex-row">
      <img
        className="w-11.25 h-18.75 border border-black object-cover"
